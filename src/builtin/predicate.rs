...
pub fn number_q(heap: &mut GcHeap, args: &[GcRef]) -> Result<GcRef, String> {
    ...
    let is_number = match &heap.get_value(*arg) {
...
pub fn type_of(heap: &mut GcHeap, args: &[GcRef]) -> Result<GcRef, String> {
    ...
    let type_name = match &heap.get_value(*arg) {
...
//         // Test with integer
//         let int_val = crate::gc::new_int(heap, num_bigint::BigInt::from(42));
//         let result = number_q(&mut ec, &[int_val]);
//         assert!(result.is_ok());
//         assert!(matches!(
//             &heap.get_value(result.unwrap()),
//             SchemeValue::Bool(true)
//         ));

//         // Test with float
//         let float_val = crate::gc::new_float(heap, 3.14);
...
//         let sym_val = crate::gc::get_symbol(heap, "foo");
...
//         let int1 = crate::gc::new_int(heap, num_bigint::BigInt::from(42));
//         let int2 = crate::gc::new_int(heap, num_bigint::BigInt::from(42));
...
//         let int3 = crate::gc::new_int(heap, num_bigint::BigInt::from(1));
//         let int4 = crate::gc::new_int(heap, num_bigint::BigInt::from(2));
...
//         let float1 = crate::gc::new_float(heap, 3.14);
//         let float2 = crate::gc::new_float(heap, 3.14);
...
//         let float3 = crate::gc::new_float(heap, 1.0);
//         let float4 = crate::gc::new_float(heap, 2.0);
...
//         let sym1 = crate::gc::get_symbol(heap, "foo");
//         let sym2 = crate::gc::get_symbol(heap, "foo");
...
//         let sym3 = crate::gc::get_symbol(heap, "bar");
//         let sym4 = crate::gc::get_symbol(heap, "baz");
...
//         let car1 = crate::gc::new_int(heap, num_bigint::BigInt::from(1));
//         let cdr1 = crate::gc::new_int(heap, num_bigint::BigInt::from(2));
//         let pair1 = crate::gc::new_pair(heap, car1, cdr1);
//         let car2 = crate::gc::new_int(heap, num_bigint::BigInt::from(1));
//         let cdr2 = crate::gc::new_int(heap, num_bigint::BigInt::from(2));
//         let pair2 = crate::gc::new_pair(heap, car2, cdr2);
...
//         let car3 = crate::gc::new_int(heap, num_bigint::BigInt::from(1));
//         let cdr3 = crate::gc::new_int(heap, num_bigint::BigInt::from(2));
//         let pair3 = crate::gc::new_pair(heap, car3, cdr3);
//         let car4 = crate::gc::new_int(heap, num_bigint::BigInt::from(3));
//         let cdr4 = crate::gc::new_int(heap, num_bigint::BigInt::from(4));
//         let pair4 = crate::gc::new_pair(heap, car4, cdr4);
...
//         let str1 = crate::gc::new_string(heap, "hello");
//         let str2 = crate::gc::new_string(heap, "hello");
...
//         let str3 = crate::gc::new_string(heap, "world");
//         let str4 = crate::gc::new_string(heap, "hello");
...
//         let vec_elem1 = crate::gc::new_int(heap, num_bigint::BigInt::from(1));
//         let vec1 = crate::gc::new_vector(heap, vec![vec_elem1]);
//         let vec_elem2 = crate::gc::new_int(heap, num_bigint::BigInt::from(1));
//         let vec2 = crate::gc::new_vector(heap, vec![vec_elem2]);
...
//         let vec_elem3 = crate::gc::new_int(heap, num_bigint::BigInt::from(1));
//         let vec3 = crate::gc::new_vector(heap, vec![vec_elem3]);
//         let vec_elem4 = crate::gc::new_int(heap, num_bigint::BigInt::from(2));
//         let vec4 = crate::gc::new_vector(heap, vec![vec_elem4]);
...
//         let bool1 = crate::gc::new_bool(heap, true);
//         let bool2 = crate::gc::new_bool(heap, true);
...
//         let bool3 = crate::gc::new_bool(heap, true);
//         let bool4 = crate::gc::new_bool(heap, false);
...
//         let char1 = crate::gc::new_char(heap, 'a');
//         let char2 = crate::gc::new_char(heap, 'a');
...
//         let char3 = crate::gc::new_char(heap, 'a');
//         let char4 = crate::gc::new_char(heap, 'b');
...
//         // Test with equal nil
//         let nil1 = crate::gc::get_nil(heap);
//         let nil2 = crate::gc::get_nil(heap);
...
//         let nil3 = crate::gc::get_nil(heap);
//         let nil4 = crate::gc::new_int(heap, num_bigint::BigInt::from(1));
...
//     #[test]
//     fn test_type_of() {
//         fn as_type(heap: &mut GcHeap, val: &GcRef) -> &'static str {
